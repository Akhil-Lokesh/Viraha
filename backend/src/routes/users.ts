...
import { muteUser, unmuteUser, getMutedUsers } from '../controllers/muteController';
...
router.post('/:username/mute', authenticate, muteUser);
router.delete('/:username/mute', authenticate, unmuteUser);
